...
INSERT INTO tu.tu_article (id, article_title, article_thumbnail_url, article_author_id, article_type,
...
VALUES (1, '给新人的一封信', null, 1, '0', '公告,新手信', 3275,
        '您好，欢迎来到 run 社区，run 是一个嵌入式知识学习交流平台。RY 取自”容易”的首字母，寓意为让电子设计变得 so easy。新手的疑问初学者都有很多疑问，在这里对这些疑问进行一一解答。我英语不好，可以学习编程吗？对于初学者来说，英语不是主要的障碍，国内有着充足的中文教程。但在接下来的学习过程中，需要阅读大量的英文文档，所以还是需要有一些英语基础和理解学习能力，配合翻译工具（如百度',
...
INSERT INTO tu.tu_article_content (id_article, article_content, article_content_html, created_time,
                                           updated_time)
VALUES (1, '您好，欢迎来到 run 社区，run 是一个嵌入式知识学习交流平台。RY 取自”容易”的首字母，寓意为让电子设计变得 so easy。
...
values (2, 'testUser', '8ce2dd866238958ac4f07870766813cdaa39a9b83a8c75e26aa50f23', 'testUser', 'testUser', '0', '0',
        null, 'testUser@run.com',
        null, '0', '2021-01-25 18:21:51', '2021-01-25 18:21:54', '2021-01-25 18:21:54', null);
INSERT INTO `tu`.`tu_user` (`id`, `account`, `password`, `nickname`, `real_name`, `sex`, `avatar_type`,
...
VALUES (65001, 'testUser1', '8ce2dd866238958ac4f07870766813cdaa39a9b83a8c75e26aa50f23', 'testUser', 'testUser1', '0',
        '0', NULL, 'testUser@run.com', NULL, '0', '2021-01-25 18:21:51', '2021-01-25 18:21:54', '2021-01-25 18:21:54',
        NULL, NULL, NULL);
...
INSERT INTO tu.tu_product (id, product_title, product_price, product_img_url, product_description, weights,
                                   created_time, updated_time)
VALUES (1, 'Nebula Pi', 2000000, 'https://static.run.com/article/1648960741563.jpg', '产品描述', 20,
...
INSERT INTO tu.tu_bank (id, bank_name, bank_owner, bank_description, created_by, created_time)
VALUES (1, '社区中央银行', 1, '社区中央银行', 1, '2020-11-26 21:24:19');
INSERT INTO tu.tu_bank (id, bank_name, bank_owner, bank_description, created_by, created_time)
VALUES (2, '社区发展与改革银行', 1, '社区发展与改革银行', 1, '2020-11-26 21:31:27');


INSERT INTO tu.tu_bank_account (id, id_bank, bank_account, account_balance, account_owner, created_time,
                                        account_type)
...
INSERT INTO `tu`.`tu_bank_account` (`id`, `id_bank`, `bank_account`, `account_balance`, `account_owner`,
