...
export const productFeatureCatalog: ProductFeature[] = [
  ...
  },
  {
    ...
    module: '编辑器',
    name: '围栏代码块',
    description: 'Markdown ``` 围栏代码块渲染为带顶栏的代码块；顶栏可切换语言（Java、XML、JSON、纯文本等）；lowlight 语法高亮（输入时纯文本，停顿约 0.5s 或移出块后上色）。代码块行首回车保留换行；在代码块起始位置可用上/左方向键移到块前光标，不额外创建正文段落。',
    status: 'testing',
    owner: 'Editor',
  },
  {
  ...
  {
    id: 'learning-in-progress-from-resource-mark',
    module: '外部资源',
    name: '学习进行中目标',
    description: '用户标记节选后，按当前用户将 ResourceItem/Excerpt 记为「进行中」学习目标（有节选优先节选）；文档页顶栏芯片可跳转/清除；粘贴或一次性插入新正文时可倒计时确认用该目标自动标记。不依赖预先创建学习计划。',
    status: 'testing',
    owner: 'Resource',
  },
  {
    ...
    module: '外部资源',
    name: '块级标记节选',
    description: '段落手柄、嵌入块工具栏或目录右键可将整块/section/引用区域标记为外部资源节选。',
    status: 'testing',
    owner: 'Resource',
  },
  {
  ...
  {
    id: 'document-unit-role-sps',
    module: '富文本',
    name: '文档单元角色与系统设计模板',
    description: '对节/段/划选标注「系统 / 问题 / 解决方案」（TextAnnotation.kind=unitRole）；斜杠插入 SPS 三节骨架，便于按系统设计模板写作。',
    status: 'testing',
    owner: 'Editor',
  },
  {
    id: 'workspace-views-learning-plan',
    module: '工作区',
    name: '侧栏视图 · 学习计划',
    description: '侧栏可切换「知识库 / 视图」。「学习计划」以 StudyFlow 目标为种子：有 prerequisite 链路则直接拉出；不足则 AI 分析生成有序知识点并持久化点与前置边后展示。',
    status: 'testing',
    owner: 'Workspace',
  },
  {
  ...
  {
    id: 'ai-learning-document-assembly',
    module: 'AI',
    name: 'AI 拼接学习文档（一期）',
    description: '左侧页面区「AI」入口：输入主题 → Agent 分析知识点/排序/匹配已有 NodeView → 预览勾选 → 始终新建文档页写入引用块/资源/PDF/知识点标题；禁止生成正文与联网。',
    status: 'testing',
    owner: 'AI',
  },
  {
