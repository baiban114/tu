...
const catalog: Record<string, PageHelp> = {
  ...
  'home.document': {
    ...
    features: [
      ...
      '顶栏「思维导图」：由当前文档目录生成只读预览；选中节点可在属性侧栏查看定位链接、跳转来源或打开内容窗口；画布操作说明见「思维导图页」帮助。',
