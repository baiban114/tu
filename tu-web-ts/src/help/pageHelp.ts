...
const catalog: Record<string, PageHelp> = {
  ...
  'home.document': {
    ...
    features: [
      ...
      '插入整个资源时需选择实体访问地址（默认第一条）；按地址类型插入 PDF 摘页 / 图片 / 资源卡片。',
