...
public class KnowledgeRelationService {
    ...
    private KnowledgeRelationDto toDto(KnowledgeRelationEntity entity, RelationTypeDefDto typeDef) {
        ...
        return new KnowledgeRelationDto(
            ...
            entity.getToPointId(),
            titleOrNull(titles, entity.getFromPointId()),
            titleOrNull(titles, entity.getToPointId()),
            fromAnchor,
            toAnchor,
            entity.getNote(),
    ...
    private static String titleOrNull(Map<String, String> titles, String pointId) {
        if (pointId == null || pointId.isBlank()) {
            return null;
        }
        return titles.get(pointId);
    }
